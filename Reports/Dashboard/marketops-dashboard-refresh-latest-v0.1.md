...
Generated: 2026-05-29T19:51:09.148Z

## Status

CONTROLLED_DEGRADED

Error: Market data unavailable: LIMITED_FRESH_BARS. Dashboard data preserved from last successful refresh.

## Controlled Degraded

- This is a controlled state: market data was unavailable (off-hours or market closed).
- lastKnownGoodPreserved: true
- lastKnownGoodGeneratedAt: 2026-05-29T19:51:08.943Z
...
- generatedAt: 2026-05-29T19:51:08.963Z
- latestBarTimestamp: 2026-05-29T13:47:00Z
- barsLoaded: 20
- quotesLoaded: 149
- refreshAgeMinutes: 0
- latestBarAgeMinutes: 364.15
- paperOnly: true
- liveTradingEnabled: false

## Paper Account

- latestRunId: paper-20260529-020644310Z
- latestRunGeneratedAt: 2026-05-29T02:06:44.310Z
- endingEquity: 172.44
- paperPnl: -830.98
- paperReturnPct: -82.81
- maxDrawdownPct: -82.81
- fakePaperTrades: 10
- qaStatus: PASS
...
- Paper equity curve: updated, points=10, source=paper_outputs
- Paper P&L: updated, points=30, source=paper_run_history
- Drawdown: updated, points=10, source=paper_outputs
- Watchlist movement summary: updated, points=1, source=alpaca_iex_derived_summary
...
- Risk rejection counts by reason: updated, points=3, source=risk_outputs
...
- Cumulative paper P&L: updated, points=11, source=paper_trade_outputs
...
- Risk decision mix: updated, points=4, source=risk_outputs
...
- Recent market movement panel: updated, points=1, source=alpaca_iex_derived_bars
...
- SKIPPED: npm run marketdata:qa - No fresh bars - skip
- SKIPPED: npm run paper:full - No fresh bars - skip paper simulation
- SKIPPED: npm run risk:explain - No fresh bars - skip
- SKIPPED: npm run cycle:build - No fresh bars - skip
- SKIPPED: npm run cycle:qa - No fresh bars - skip
- SKIPPED: npm run dashboard:build - No fresh bars - preserve existing
- SKIPPED: npm run paper:refresh-site - No fresh bars - skip
- SKIPPED: npm run dashboard:qa - No fresh bars - skip
- SKIPPED: npm run dashboard:public-refresh:qa - No fresh bars - skip
