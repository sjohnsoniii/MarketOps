...
function buildDashboardBundle() {
  ...
  return {
    ...
    chartDataSources: {
      ...
      equityCurve: equitySeries.length > 0 ? "real_paper_equity_curve" : "no_trades",
      paperEquityCurve: equitySeries.length > 0 ? "real_paper_equity_curve" : "no_trades",
      ...
      drawdownSeries: equitySeries.length > 0 ? "real_paper_equity_curve" : "no_trades",
